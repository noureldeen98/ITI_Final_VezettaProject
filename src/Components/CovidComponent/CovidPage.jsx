...
const CovidPage = () => {
    ...
    const collectionsOfDoctors = useSelector(
        (state) => state.doctorCollectionReducer
        ...
        <>
            ...
            <div className="row afterNav">
                ...
                >
                    ...
                    <p className="text-secondary fs-4 container">
                        احجز اونلاين او كلم &nbsp;
                        <i className="fas fa-phone text-danger fs-5"></i>
                        "&nbsp;16676"
                    </p>
                ...
                <div className="card container aboutCovidCenter">
                    <div className="row">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <img
                                        alt="photo"
                                        src="me.jpg"
                                        className="rounded-circle imageOfAboutCovidCenter  me-1 me-lg-2 mt-3 mb-5"
                                    />
                                </div>
                        ...
                        <div className="col-lg-6" style={{ top: "80px", left: "150px" }}>
                            <button
                                type="button"
                                className="btn btn-primary mh-100 m-lg-5 "
                                style={{
                                    flexBasis: " 70%",
                                    marginRight: "10px",
                                    marginBottom: "10px",
